			...
			<div class="modal-body">
				<form class="js-auth-form" method="POST">
					<div class="form-group">
						...
						<br>
						<div class="input-group">
							<span class="input-group-addon transparent"><span class="glyphicon glyphicon-asterisk"></span></span>
							<input class="form-control left-border-none" placeholder="Пароль" type="password" name="password">
						</div>
					</div>
				</form>
			</div>
				...
				<form>
					<div class="form-group">
						...
						<div class="input-group">
							...
							<input class="form-control left-border-none" placeholder="Телефон" type="text" name="phone">
						</div>
						<div class="input-group">
							<span class="input-group-addon transparent"><span class="glyphicon glyphicon-home"></span></span>
							<input class="form-control left-border-none" placeholder="Адрес" type="text" name="address">
						</div>
					</div>
				</form>
			</div>
