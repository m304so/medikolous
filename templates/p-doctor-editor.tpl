		...
		<form class="js-form-new-doctor" method="POST">
			<div class="col-xs-12 col-md-6 col-lg-4">
				<div class="form-group">
					...
					<div class="input-group">
						<span class="input-group-addon transparent"><span class="glyphicon glyphicon-user"></span></span>
						<input class="form-control left-border-none" placeholder="Имя" type="text" name="name" value="{$doctor.name}">
						<input class="form-control left-border-none" placeholder="Фамилия" type="text" name="surname" value="{$doctor.surname}">
						<input class="form-control left-border-none" placeholder="Отчество" type="text" name="patronymic" value="{$doctor.patronymic}">
					</div>
					<br>
				</div>
				<br>
